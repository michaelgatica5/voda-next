    ...
    return (
        <div className="flex items-center">
                <Link href={'#'} style={{textDecoration: 'none'}} className={`flex transition-all duration-200 ease-in-out ${styles.linkHead}`}>
                    <div className={`grid`}>
                        <FontAwesomeIcon className={`w-6`} icon={faClockRotateLeft} />
                ...
                <Link href={'#'} style={{textDecoration: 'none'}} className={`flex transition-all duration-200 ease-in-out ${styles.linkHead}`}>
                    <div className={`grid ${styles.innerLink}`}>
                        ...
                        <FontAwesomeIcon className={`w-5`} icon={faFileLines} />
                ...
                <Link href={'#'} style={{textDecoration: 'none'}} className={`flex transition-all duration-200 ease-in-out ${styles.linkHead}`}>
                    <div className={`grid ${styles.innerLink}`}>
                        ...
                        <FontAwesomeIcon className={`w-4`} icon={faDollarSign} />
                ...
                <Link href={'#'} style={{textDecoration: 'none'}} className={`flex transition-all duration-200 ease-in-out ${styles.linkHead}`}>
                    <div className={`grid ${styles.innerLink}`}>
                        ...
                        <FontAwesomeIcon className={`w-6`} icon={faCalendarCheck} />
                ...
                <Link href={'#'} style={{textDecoration: 'none'}} className={`flex transition-all duration-200 ease-in-out ${styles.linkHead}`}>
                    <div className={`grid ${styles.innerLink}`}>
                        ...
                        <FontAwesomeIcon className={`w-6`} icon={faKey} />
